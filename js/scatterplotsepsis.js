...
//Append new line
  ...
  var tip = d3.tip().attr('class', 'd3-tip')
    .html(function(d) {
        ...
        text += "<strong>%mortality due to Sepsis:</strong> <span style='color:blue;text-transform:capitalize'>" + d3.format(".2f")(d.Sepsis) + "</span><br>";
...
svg10.call(tip);
  ...
  xAxisGenerator.tickValues([1.5, 2.5, 3.5]);
...
svg10.append("text")
    ...
    .attr("font-size", "22px")
    .attr("fill", "blue")
    .text("1% increase in mortality due to Sepsis --> 7.5 times increase in excess deaths");
