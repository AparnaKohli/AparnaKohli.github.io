var margin = {top: 40, right: 90, bottom: 100, left: 350},
...
var tip = d3.tip().attr('class', 'd3-tip')
    .html(function(d) {
        var text = "<strong>State:</strong> <span style='color:blue'>" + d.data.State + "</span><br>";
        text += "<strong>Condition:</strong> <span style='color:blue;text-transform:capitalize'>" + d.data.Category + "</span><br>";
        text += "<strong>Percentage of deaths:</strong> <span style='color:blue'>" + d3.format(".2f")(d.data.count) + "</span><br>";
...
svg5.append("text")
        ...
        .text("Hover on the individual sections on the chart!"); 
